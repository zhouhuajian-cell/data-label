  ...
  <div class="bills-page">
    ...
    <el-card shadow="never">
      ...
      <el-table v-loading="loading" :data="list" border size="small">
        ...
        <el-table-column label="提交" :width="w(150)" show-overflow-tooltip>
          <template #default="s">{{ s.row.createdByName }}<br>{{ s.row.createdAt }}</template>
        </el-table-column>
...
const { isNarrow, statColumns, descColumns, drawerSize, tableScale } = useResponsive()

// 窄屏按比例压缩表格固定列宽，减少横向滚动
