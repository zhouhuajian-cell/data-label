<template>
  <div class="dash-wrap">
      <div class="card-row" :style="{ gridTemplateColumns: `repeat(${statColumns}, 1fr)` }">
...
<style scoped>
.card-row { display: grid; gap: 12px; margin-bottom: 14px; }
.stat-card { text-align: center; cursor: pointer; }
.num { font-size: 28px; font-weight: bold; }
.label { color: #909399; margin-top: 6px; font-size: 13.5px; }
.chart-row { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; }
@media (max-width: 1180px) { .chart-row { grid-template-columns: 1fr; } }
</style>
